...
function DetalleOr() {
  ...
  const valoresProgreso = [45, 90, 20, 75, 60, 30, 15, 40, 70, 60, 45, 85, 90];
  ...
  const provinciasOruro = provincias.Bolivia["Oruro"].map((provincia, index) => {
  ...
  const filteredData = provinciasOruro.filter(provincia =>
    ...
    <div className="container pt-0">
      <Card>
        <Card.Header className='d-flex justify-content-between align-items-center'>
          <span className="text-center">Datos de provincias del departamento de <b>Oruro-04</b></span>
