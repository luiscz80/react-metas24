...
function DetalleCoch() {

  const valoresProgreso = [45, 90, 20, 75, 60, 30, 15, 40, 70, 55, 60, 45, 85, 90];
  ...
  const provinciasCochabamba = provincias.Bolivia["Cochabamba"].map((provincia, index) => {
  ...
  const filteredData = provinciasCochabamba.filter(provincia =>
    ...
    <div className="container pt-0">
      <Card>
        <Card.Header className='d-flex justify-content-between align-items-center'>
          <span className="text-center">Datos de provincias del departamento de <b>Cochabamba-03</b></span>
