...
function DetalleTar() {
  ...
  const valoresProgreso = [35, 30, 15, 40, 70, 60, 45, 85, 80];
  ...
  const provinciasTarija = provincias.Bolivia["Tarija"].map((provincia, index) => {
  ...
  const filteredData = provinciasTarija.filter(provincia =>
    ...
    <div className="container pt-0">
      <Card>
        <Card.Header className='d-flex justify-content-between align-items-center'>
          <span className="text-center">Datos de provincias del departamento de <b>Tarija-06</b></span>
