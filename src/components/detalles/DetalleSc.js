...
function DetalleSantaC() {

  const valoresProgreso = [30, 15, 40, 70, 55, 45, 68, 20, 75, 22, 60, 45, 85, 90];
  ...
  const provinciasSantaCruz = provincias.Bolivia["Santa Cruz"].map((provincia, index) => {
  ...
  const filteredData = provinciasSantaCruz.filter(provincia =>
    ...
    <div className="container pt-0">
      <Card>
        <Card.Header className='d-flex justify-content-between align-items-center'>
          <span className="text-center">Datos de provincias del departamento de <b>Santa Cruz-07</b></span>
