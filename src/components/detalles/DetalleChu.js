...
function DetalleChu() {
  ...
  const valoresProgreso = [50, 15, 25, 70, 55, 82, 60, 45];
  ...
  const provinciasChuquisaca = provincias.Bolivia["Chuquisaca"].map((provincia, index) => {
  ...
  const filteredData = provinciasChuquisaca.filter(provincia =>
    ...
    <div className="container pt-0">
      <Card>
        <Card.Header className='d-flex justify-content-between align-items-center'>
          <span className="text-center">Datos de provincias del departamento de <b>Chuquisaca-01</b></span>
