...
function DetalleBeni() {

  const valoresProgreso = [55, 82, 60, 45, 50, 15, 25, 70];
  ...
  const provinciasBeni = provincias.Bolivia["Beni"].map((provincia, index) => {
  ...
  const filteredData = provinciasBeni.filter(provincia =>
    ...
    <div className="container pt-0">
      <Card>
        <Card.Header className='d-flex justify-content-between align-items-center'>
          <span className="text-center">Datos de provincias del departamento de <b>Beni-08</b></span>
