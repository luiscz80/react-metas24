...
function DetallePot() {
  ...
  const valoresProgreso = [60, 30, 15, 40, 70, 60, 45, 85, 90,45, 90, 20, 75];
  ...
  const provinciasPotosi = provincias.Bolivia["Potosi"].map((provincia, index) => {
  ...
  const filteredData = provinciasPotosi.filter(provincia =>
    ...
    <div className="container pt-0">
      <Card>
        <Card.Header className='d-flex justify-content-between align-items-center'>
          <span className="text-center">Datos de provincias del departamento de <b>Potosi-05</b></span>
